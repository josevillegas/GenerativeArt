  ...
  var body: some View {
    if horizontalSizeClass == .compact {
      ...
      NavigationSplitView(columnVisibility: $splitViewVisibility) {
        ...
        DrawingView(drawingID: drawingID, drawingType: selectedDrawingType ?? .defaultType, foregroundColor: foregroundColor,
                    backgroundColor: backgroundColor, tileSize: tileSize)
        .modifier(ToolbarModifier(type: selectedDrawingType ?? .defaultType, foregroundColor: $foregroundColor,
